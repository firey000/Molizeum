...
$name = $_SESSION['user_name'] ?? 'Сотрудник';
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <title>Панель сотрудника — Молизеум</title>
...
<header class="panel-header">
    <div class="panel-header-left">
        <a href="registration.php" class="panel-logo">Молизеум</a>
        <span class="panel-subtitle">Панель сотрудника · Работа с клиентами</span>
    </div>
    <div class="panel-header-right">
        <span style="font-size:13px;color:#6b7280;font-weight:500"><?= htmlspecialchars($name) ?></span>
...
<nav class="panel-nav">
    <a href="registration.php" class="<?= $current==='registration.php'?'active':'' ?>">
    ...
    <a href="snacks.php" class="<?= $current==='snacks.php'?'active':'' ?>">
    ...
    <a href="tariffs.php" class="<?= $current==='tariffs.php'?'active':'' ?>">
